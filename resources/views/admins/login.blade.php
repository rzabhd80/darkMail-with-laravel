...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <form method="post" action="{{route("adminsLogin")}}">
                @csrf
                <div class="form-group">
                    <label class="label">email</label>
                    <input name="email" type="email" class="form-control {{$errors->has("email")?"border-danger":""}}">
                    @if ($errors->has("email"))
                ...
                <div class="form-group">
                    ...
                    <input name="password" type="password" class="form-control {{$errors->has("password")?"border-danger":""}}">
